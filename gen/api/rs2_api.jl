# Julia wrapper for header: librealsense/include/librealsense2/h/rs_advanced_mode_command.h
# Automatically generated using Clang.jl wrap_c, version 0.0.0

# Julia wrapper for header: librealsense/include/librealsense2/h/rs_context.h
# Automatically generated using Clang.jl wrap_c, version 0.0.0
...
function rs2_delete_context(context)
    ccall((:rs2_delete_context, librealsense2), Void, (Ptr{rs2_context},), context)
end

function rs2_set_devices_changed_callback_cpp(context, callback, error)
    ccall((:rs2_set_devices_changed_callback_cpp, librealsense2), Void, (Ptr{rs2_context}, Ptr{rs2_devices_changed_callback}, Ptr{Ptr{rs2_error}}), context, callback, error)
end

function rs2_set_devices_changed_callback(context, callback, user, error)
    ccall((:rs2_set_devices_changed_callback, librealsense2), Void, (Ptr{rs2_context}, rs2_devices_changed_callback_ptr, Ptr{Void}, Ptr{Ptr{rs2_error}}), context, callback, user, error)
end
...
function rs2_context_remove_device(ctx, file, error)
    ccall((:rs2_context_remove_device, librealsense2), Void, (Ptr{rs2_context}, Cstring, Ptr{Ptr{rs2_error}}), ctx, file, error)
end
...
function rs2_delete_device_hub(hub)
    ccall((:rs2_delete_device_hub, librealsense2), Void, (Ptr{rs2_device_hub},), hub)
end
...
# Julia wrapper for header: librealsense/include/librealsense2/h/rs_device.h
# Automatically generated using Clang.jl wrap_c, version 0.0.0
...
function rs2_delete_device_list(info_list)
    ccall((:rs2_delete_device_list, librealsense2), Void, (Ptr{rs2_device_list},), info_list)
end
...
function rs2_delete_device(device)
    ccall((:rs2_delete_device, librealsense2), Void, (Ptr{rs2_device},), device)
end
...
function rs2_hardware_reset(device, error)
    ccall((:rs2_hardware_reset, librealsense2), Void, (Ptr{rs2_device}, Ptr{Ptr{rs2_error}}), device, error)
end

function rs2_send_and_receive_raw_data(device, raw_data_to_send, size_of_raw_data_to_send, error)
    ccall((:rs2_send_and_receive_raw_data, librealsense2), Ptr{rs2_raw_data_buffer}, (Ptr{rs2_device}, Ptr{Void}, UInt32, Ptr{Ptr{rs2_error}}), device, raw_data_to_send, size_of_raw_data_to_send, error)
end
...
function rs2_loopback_enable(device, from_file, error)
    ccall((:rs2_loopback_enable, librealsense2), Void, (Ptr{rs2_device}, Cstring, Ptr{Ptr{rs2_error}}), device, from_file, error)
end

function rs2_loopback_disable(device, error)
    ccall((:rs2_loopback_disable, librealsense2), Void, (Ptr{rs2_device}, Ptr{Ptr{rs2_error}}), device, error)
end
...
function rs2_connect_tm2_controller(device, mac_addr, error)
    ccall((:rs2_connect_tm2_controller, librealsense2), Void, (Ptr{rs2_device}, Ptr{Cuchar}, Ptr{Ptr{rs2_error}}), device, mac_addr, error)
end

function rs2_disconnect_tm2_controller(device, id, error)
    ccall((:rs2_disconnect_tm2_controller, librealsense2), Void, (Ptr{rs2_device}, Cint, Ptr{Ptr{rs2_error}}), device, id, error)
end
# Julia wrapper for header: librealsense/include/librealsense2/h/rs_frame.h
# Automatically generated using Clang.jl wrap_c, version 0.0.0
...
function rs2_get_frame_data(frame, error)
    ccall((:rs2_get_frame_data, librealsense2), Ptr{Void}, (Ptr{rs2_frame}, Ptr{Ptr{rs2_error}}), frame, error)
end
...
function rs2_frame_add_ref(frame, error)
    ccall((:rs2_frame_add_ref, librealsense2), Void, (Ptr{rs2_frame}, Ptr{Ptr{rs2_error}}), frame, error)
end

function rs2_release_frame(frame)
    ccall((:rs2_release_frame, librealsense2), Void, (Ptr{rs2_frame},), frame)
end

function rs2_keep_frame(frame)
    ccall((:rs2_keep_frame, librealsense2), Void, (Ptr{rs2_frame},), frame)
end
...
function rs2_export_to_ply(frame, fname, texture, error)
    ccall((:rs2_export_to_ply, librealsense2), Void, (Ptr{rs2_frame}, Cstring, Ptr{rs2_frame}, Ptr{Ptr{rs2_error}}), frame, fname, texture, error)
end
...
function rs2_synthetic_frame_ready(source, frame, error)
    ccall((:rs2_synthetic_frame_ready, librealsense2), Void, (Ptr{rs2_source}, Ptr{rs2_frame}, Ptr{Ptr{rs2_error}}), source, frame, error)
end

function rs2_pose_frame_get_pose_data(frame, pose, error)
    ccall((:rs2_pose_frame_get_pose_data, librealsense2), Void, (Ptr{rs2_frame}, Ptr{rs2_pose}, Ptr{Ptr{rs2_error}}), frame, pose, error)
end
# Julia wrapper for header: librealsense/include/librealsense2/h/rs_option.h
# Automatically generated using Clang.jl wrap_c, version 0.0.0
...
function rs2_set_option(options, option, value, error)
    ccall((:rs2_set_option, librealsense2), Void, (Ptr{rs2_options}, rs2_option, Cfloat, Ptr{Ptr{rs2_error}}), options, option, value, error)
end
...
function rs2_get_option_range(sensor, option, min, max, step, def, error)
    ccall((:rs2_get_option_range, librealsense2), Void, (Ptr{rs2_options}, rs2_option, Ptr{Cfloat}, Ptr{Cfloat}, Ptr{Cfloat}, Ptr{Cfloat}, Ptr{Ptr{rs2_error}}), sensor, option, min, max, step, def, error)
end
...
# Julia wrapper for header: librealsense/include/librealsense2/h/rs_processing.h
# Automatically generated using Clang.jl wrap_c, version 0.0.0
...
function rs2_start_processing(block, on_frame, error)
    ccall((:rs2_start_processing, librealsense2), Void, (Ptr{rs2_processing_block}, Ptr{rs2_frame_callback}, Ptr{Ptr{rs2_error}}), block, on_frame, error)
end

function rs2_start_processing_queue(block, queue, error)
    ccall((:rs2_start_processing_queue, librealsense2), Void, (Ptr{rs2_processing_block}, Ptr{rs2_frame_queue}, Ptr{Ptr{rs2_error}}), block, queue, error)
end

function rs2_process_frame(block, frame, error)
    ccall((:rs2_process_frame, librealsense2), Void, (Ptr{rs2_processing_block}, Ptr{rs2_frame}, Ptr{Ptr{rs2_error}}), block, frame, error)
end

function rs2_delete_processing_block(block)
    ccall((:rs2_delete_processing_block, librealsense2), Void, (Ptr{rs2_processing_block},), block)
end
...
function rs2_delete_frame_queue(queue)
    ccall((:rs2_delete_frame_queue, librealsense2), Void, (Ptr{rs2_frame_queue},), queue)
end
...
function rs2_enqueue_frame(frame, queue)
    ccall((:rs2_enqueue_frame, librealsense2), Void, (Ptr{rs2_frame}, Ptr{Void}), frame, queue)
end
...
# Julia wrapper for header: librealsense/include/librealsense2/h/rs_record_playback.h
# Automatically generated using Clang.jl wrap_c, version 0.0.0
...
function rs2_record_device_pause(device, error)
    ccall((:rs2_record_device_pause, librealsense2), Void, (Ptr{rs2_device}, Ptr{Ptr{rs2_error}}), device, error)
end

function rs2_record_device_resume(device, error)
    ccall((:rs2_record_device_resume, librealsense2), Void, (Ptr{rs2_device}, Ptr{Ptr{rs2_error}}), device, error)
end
...
function rs2_playback_seek(device, time, error)
    ccall((:rs2_playback_seek, librealsense2), Void, (Ptr{rs2_device}, Clonglong, Ptr{Ptr{rs2_error}}), device, time, error)
end
...
function rs2_playback_device_resume(device, error)
    ccall((:rs2_playback_device_resume, librealsense2), Void, (Ptr{rs2_device}, Ptr{Ptr{rs2_error}}), device, error)
end

function rs2_playback_device_pause(device, error)
    ccall((:rs2_playback_device_pause, librealsense2), Void, (Ptr{rs2_device}, Ptr{Ptr{rs2_error}}), device, error)
end

function rs2_playback_device_set_real_time(device, real_time, error)
    ccall((:rs2_playback_device_set_real_time, librealsense2), Void, (Ptr{rs2_device}, Cint, Ptr{Ptr{rs2_error}}), device, real_time, error)
end
...
function rs2_playback_device_set_status_changed_callback(device, callback, error)
    ccall((:rs2_playback_device_set_status_changed_callback, librealsense2), Void, (Ptr{rs2_device}, Ptr{rs2_playback_status_changed_callback}, Ptr{Ptr{rs2_error}}), device, callback, error)
end
...
function rs2_playback_device_set_playback_speed(device, speed, error)
    ccall((:rs2_playback_device_set_playback_speed, librealsense2), Void, (Ptr{rs2_device}, Cfloat, Ptr{Ptr{rs2_error}}), device, speed, error)
end

function rs2_playback_device_stop(device, error)
    ccall((:rs2_playback_device_stop, librealsense2), Void, (Ptr{rs2_device}, Ptr{Ptr{rs2_error}}), device, error)
end
# Julia wrapper for header: librealsense/include/librealsense2/h/rs_sensor.h
# Automatically generated using Clang.jl wrap_c, version 0.0.0
...
function rs2_delete_sensor_list(info_list)
    ccall((:rs2_delete_sensor_list, librealsense2), Void, (Ptr{rs2_sensor_list},), info_list)
end
...
function rs2_delete_sensor(sensor)
    ccall((:rs2_delete_sensor, librealsense2), Void, (Ptr{rs2_sensor},), sensor)
end
...
function rs2_set_region_of_interest(sensor, min_x, min_y, max_x, max_y, error)
    ccall((:rs2_set_region_of_interest, librealsense2), Void, (Ptr{rs2_sensor}, Cint, Cint, Cint, Cint, Ptr{Ptr{rs2_error}}), sensor, min_x, min_y, max_x, max_y, error)
end

function rs2_get_region_of_interest(sensor, min_x, min_y, max_x, max_y, error)
    ccall((:rs2_get_region_of_interest, librealsense2), Void, (Ptr{rs2_sensor}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Ptr{rs2_error}}), sensor, min_x, min_y, max_x, max_y, error)
end

function rs2_open(device, profile, error)
    ccall((:rs2_open, librealsense2), Void, (Ptr{rs2_sensor}, Ptr{rs2_stream_profile}, Ptr{Ptr{rs2_error}}), device, profile, error)
end

function rs2_open_multiple(device, profiles, count, error)
    ccall((:rs2_open_multiple, librealsense2), Void, (Ptr{rs2_sensor}, Ptr{Ptr{rs2_stream_profile}}, Cint, Ptr{Ptr{rs2_error}}), device, profiles, count, error)
end

function rs2_close(sensor, error)
    ccall((:rs2_close, librealsense2), Void, (Ptr{rs2_sensor}, Ptr{Ptr{rs2_error}}), sensor, error)
end

function rs2_start(sensor, on_frame, user, error)
    ccall((:rs2_start, librealsense2), Void, (Ptr{rs2_sensor}, rs2_frame_callback_ptr, Ptr{Void}, Ptr{Ptr{rs2_error}}), sensor, on_frame, user, error)
end

function rs2_start_cpp(sensor, callback, error)
    ccall((:rs2_start_cpp, librealsense2), Void, (Ptr{rs2_sensor}, Ptr{rs2_frame_callback}, Ptr{Ptr{rs2_error}}), sensor, callback, error)
end

function rs2_start_queue(sensor, queue, error)
    ccall((:rs2_start_queue, librealsense2), Void, (Ptr{rs2_sensor}, Ptr{rs2_frame_queue}, Ptr{Ptr{rs2_error}}), sensor, queue, error)
end

function rs2_stop(sensor, error)
    ccall((:rs2_stop, librealsense2), Void, (Ptr{rs2_sensor}, Ptr{Ptr{rs2_error}}), sensor, error)
end

function rs2_set_notifications_callback(sensor, on_notification, user, error)
    ccall((:rs2_set_notifications_callback, librealsense2), Void, (Ptr{rs2_sensor}, rs2_notification_callback_ptr, Ptr{Void}, Ptr{Ptr{rs2_error}}), sensor, on_notification, user, error)
end

function rs2_set_notifications_callback_cpp(sensor, callback, error)
    ccall((:rs2_set_notifications_callback_cpp, librealsense2), Void, (Ptr{rs2_sensor}, Ptr{rs2_notifications_callback}, Ptr{Ptr{rs2_error}}), sensor, callback, error)
end
...
function rs2_get_stream_profile_data(mode, stream, format, index, unique_id, framerate, error)
    ccall((:rs2_get_stream_profile_data, librealsense2), Void, (Ptr{rs2_stream_profile}, Ptr{rs2_stream}, Ptr{rs2_format}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Ptr{rs2_error}}), mode, stream, format, index, unique_id, framerate, error)
end

function rs2_set_stream_profile_data(mode, stream, index, format, error)
    ccall((:rs2_set_stream_profile_data, librealsense2), Void, (Ptr{rs2_stream_profile}, rs2_stream, Cint, rs2_format, Ptr{Ptr{rs2_error}}), mode, stream, index, format, error)
end
...
function rs2_delete_stream_profile(mode)
    ccall((:rs2_delete_stream_profile, librealsense2), Void, (Ptr{rs2_stream_profile},), mode)
end

function rs2_stream_profile_is(mode, _type, error)
    ccall((:rs2_stream_profile_is, librealsense2), Cint, (Ptr{rs2_stream_profile}, rs2_extension, Ptr{Ptr{rs2_error}}), mode, _type, error)
end

function rs2_get_video_stream_resolution(mode, width, height, error)
    ccall((:rs2_get_video_stream_resolution, librealsense2), Void, (Ptr{rs2_stream_profile}, Ptr{Cint}, Ptr{Cint}, Ptr{Ptr{rs2_error}}), mode, width, height, error)
end

function rs2_get_motion_intrinsics(mode, intrinsics, error)
    ccall((:rs2_get_motion_intrinsics, librealsense2), Void, (Ptr{rs2_stream_profile}, Ptr{rs2_motion_device_intrinsic}, Ptr{Ptr{rs2_error}}), mode, intrinsics, error)
end
...
function rs2_delete_stream_profiles_list(list)
    ccall((:rs2_delete_stream_profiles_list, librealsense2), Void, (Ptr{rs2_stream_profile_list},), list)
end

function rs2_get_extrinsics(from, to, extrin, error)
    ccall((:rs2_get_extrinsics, librealsense2), Void, (Ptr{rs2_stream_profile}, Ptr{rs2_stream_profile}, Ptr{rs2_extrinsics}, Ptr{Ptr{rs2_error}}), from, to, extrin, error)
end

function rs2_register_extrinsics(from, to, extrin, error)
    ccall((:rs2_register_extrinsics, librealsense2), Void, (Ptr{rs2_stream_profile}, Ptr{rs2_stream_profile}, rs2_extrinsics, Ptr{Ptr{rs2_error}}), from, to, extrin, error)
end

function rs2_get_video_stream_intrinsics(mode, intrinsics, error)
    ccall((:rs2_get_video_stream_intrinsics, librealsense2), Void, (Ptr{rs2_stream_profile}, Ptr{rs2_intrinsics}, Ptr{Ptr{rs2_error}}), mode, intrinsics, error)
end
# Julia wrapper for header: librealsense/include/librealsense2/h/rs_types.h
# Automatically generated using Clang.jl wrap_c, version 0.0.0
...
function rs2_exception_type_to_string(_type)
    ccall((:rs2_exception_type_to_string, librealsense2), Cstring, (rs2_exception_type,), _type)
end
...
function rs2_extension_type_to_string(_type)
    ccall((:rs2_extension_type_to_string, librealsense2), Cstring, (rs2_extension,), _type)
end

function rs2_extension_to_string(_type)
    ccall((:rs2_extension_to_string, librealsense2), Cstring, (rs2_extension,), _type)
end
...
function rs2_free_error(error)
    ccall((:rs2_free_error, librealsense2), Void, (Ptr{rs2_error},), error)
end
# Julia wrapper for header: librealsense/include/librealsense2/rs.h
# Automatically generated using Clang.jl wrap_c, version 0.0.0
...
function rs2_delete_raw_data(buffer)
    ccall((:rs2_delete_raw_data, librealsense2), Void, (Ptr{rs2_raw_data_buffer},), buffer)
end
...
function rs2_log_to_console(min_severity, error)
    ccall((:rs2_log_to_console, librealsense2), Void, (rs2_log_severity, Ptr{Ptr{rs2_error}}), min_severity, error)
end

function rs2_log_to_file(min_severity, file_path, error)
    ccall((:rs2_log_to_file, librealsense2), Void, (rs2_log_severity, Cstring, Ptr{Ptr{rs2_error}}), min_severity, file_path, error)
end

function rs2_log(severity, message, error)
    ccall((:rs2_log, librealsense2), Void, (rs2_log_severity, Cstring, Ptr{Ptr{rs2_error}}), severity, message, error)
end
...
# Julia wrapper for header: librealsense/include/librealsense2/rs_advanced_mode.h
# Automatically generated using Clang.jl wrap_c, version 0.0.0


function rs2_toggle_advanced_mode(dev, enable, error)
    ccall((:rs2_toggle_advanced_mode, librealsense2), Void, (Ptr{rs2_device}, Cint, Ptr{Ptr{rs2_error}}), dev, enable, error)
end

function rs2_is_enabled(dev, enabled, error)
    ccall((:rs2_is_enabled, librealsense2), Void, (Ptr{rs2_device}, Ptr{Cint}, Ptr{Ptr{rs2_error}}), dev, enabled, error)
end

function rs2_set_depth_control(dev, group, error)
    ccall((:rs2_set_depth_control, librealsense2), Void, (Ptr{rs2_device}, Ptr{STDepthControlGroup}, Ptr{Ptr{rs2_error}}), dev, group, error)
end

function rs2_get_depth_control(dev, group, mode, error)
    ccall((:rs2_get_depth_control, librealsense2), Void, (Ptr{rs2_device}, Ptr{STDepthControlGroup}, Cint, Ptr{Ptr{rs2_error}}), dev, group, mode, error)
end

function rs2_set_rsm(dev, group, error)
    ccall((:rs2_set_rsm, librealsense2), Void, (Ptr{rs2_device}, Ptr{STRsm}, Ptr{Ptr{rs2_error}}), dev, group, error)
end

function rs2_get_rsm(dev, group, mode, error)
    ccall((:rs2_get_rsm, librealsense2), Void, (Ptr{rs2_device}, Ptr{STRsm}, Cint, Ptr{Ptr{rs2_error}}), dev, group, mode, error)
end

function rs2_set_rau_support_vector_control(dev, group, error)
    ccall((:rs2_set_rau_support_vector_control, librealsense2), Void, (Ptr{rs2_device}, Ptr{STRauSupportVectorControl}, Ptr{Ptr{rs2_error}}), dev, group, error)
end

function rs2_get_rau_support_vector_control(dev, group, mode, error)
    ccall((:rs2_get_rau_support_vector_control, librealsense2), Void, (Ptr{rs2_device}, Ptr{STRauSupportVectorControl}, Cint, Ptr{Ptr{rs2_error}}), dev, group, mode, error)
end

function rs2_set_color_control(dev, group, error)
    ccall((:rs2_set_color_control, librealsense2), Void, (Ptr{rs2_device}, Ptr{STColorControl}, Ptr{Ptr{rs2_error}}), dev, group, error)
end

function rs2_get_color_control(dev, group, mode, error)
    ccall((:rs2_get_color_control, librealsense2), Void, (Ptr{rs2_device}, Ptr{STColorControl}, Cint, Ptr{Ptr{rs2_error}}), dev, group, mode, error)
end

function rs2_set_rau_thresholds_control(dev, group, error)
    ccall((:rs2_set_rau_thresholds_control, librealsense2), Void, (Ptr{rs2_device}, Ptr{STRauColorThresholdsControl}, Ptr{Ptr{rs2_error}}), dev, group, error)
end

function rs2_get_rau_thresholds_control(dev, group, mode, error)
    ccall((:rs2_get_rau_thresholds_control, librealsense2), Void, (Ptr{rs2_device}, Ptr{STRauColorThresholdsControl}, Cint, Ptr{Ptr{rs2_error}}), dev, group, mode, error)
end

function rs2_set_slo_color_thresholds_control(dev, group, error)
    ccall((:rs2_set_slo_color_thresholds_control, librealsense2), Void, (Ptr{rs2_device}, Ptr{STSloColorThresholdsControl}, Ptr{Ptr{rs2_error}}), dev, group, error)
end

function rs2_get_slo_color_thresholds_control(dev, group, mode, error)
    ccall((:rs2_get_slo_color_thresholds_control, librealsense2), Void, (Ptr{rs2_device}, Ptr{STSloColorThresholdsControl}, Cint, Ptr{Ptr{rs2_error}}), dev, group, mode, error)
end

function rs2_set_slo_penalty_control(dev, group, error)
    ccall((:rs2_set_slo_penalty_control, librealsense2), Void, (Ptr{rs2_device}, Ptr{STSloPenaltyControl}, Ptr{Ptr{rs2_error}}), dev, group, error)
end

function rs2_get_slo_penalty_control(dev, group, mode, error)
    ccall((:rs2_get_slo_penalty_control, librealsense2), Void, (Ptr{rs2_device}, Ptr{STSloPenaltyControl}, Cint, Ptr{Ptr{rs2_error}}), dev, group, mode, error)
end

function rs2_set_hdad(dev, group, error)
    ccall((:rs2_set_hdad, librealsense2), Void, (Ptr{rs2_device}, Ptr{STHdad}, Ptr{Ptr{rs2_error}}), dev, group, error)
end

function rs2_get_hdad(dev, group, mode, error)
    ccall((:rs2_get_hdad, librealsense2), Void, (Ptr{rs2_device}, Ptr{STHdad}, Cint, Ptr{Ptr{rs2_error}}), dev, group, mode, error)
end

function rs2_set_color_correction(dev, group, error)
    ccall((:rs2_set_color_correction, librealsense2), Void, (Ptr{rs2_device}, Ptr{STColorCorrection}, Ptr{Ptr{rs2_error}}), dev, group, error)
end

function rs2_get_color_correction(dev, group, mode, error)
    ccall((:rs2_get_color_correction, librealsense2), Void, (Ptr{rs2_device}, Ptr{STColorCorrection}, Cint, Ptr{Ptr{rs2_error}}), dev, group, mode, error)
end

function rs2_set_depth_table(dev, group, error)
    ccall((:rs2_set_depth_table, librealsense2), Void, (Ptr{rs2_device}, Ptr{STDepthTableControl}, Ptr{Ptr{rs2_error}}), dev, group, error)
end

function rs2_get_depth_table(dev, group, mode, error)
    ccall((:rs2_get_depth_table, librealsense2), Void, (Ptr{rs2_device}, Ptr{STDepthTableControl}, Cint, Ptr{Ptr{rs2_error}}), dev, group, mode, error)
end

function rs2_set_ae_control(dev, group, error)
    ccall((:rs2_set_ae_control, librealsense2), Void, (Ptr{rs2_device}, Ptr{STAEControl}, Ptr{Ptr{rs2_error}}), dev, group, error)
end

function rs2_get_ae_control(dev, group, mode, error)
    ccall((:rs2_get_ae_control, librealsense2), Void, (Ptr{rs2_device}, Ptr{STAEControl}, Cint, Ptr{Ptr{rs2_error}}), dev, group, mode, error)
end

function rs2_set_census(dev, group, error)
    ccall((:rs2_set_census, librealsense2), Void, (Ptr{rs2_device}, Ptr{STCensusRadius}, Ptr{Ptr{rs2_error}}), dev, group, error)
end

function rs2_get_census(dev, group, mode, error)
    ccall((:rs2_get_census, librealsense2), Void, (Ptr{rs2_device}, Ptr{STCensusRadius}, Cint, Ptr{Ptr{rs2_error}}), dev, group, mode, error)
end

function rs2_load_json(dev, json_content, content_size, error)
    ccall((:rs2_load_json, librealsense2), Void, (Ptr{rs2_device}, Ptr{Void}, UInt32, Ptr{Ptr{rs2_error}}), dev, json_content, content_size, error)
end
...
# Julia wrapper for header: librealsense/include/librealsense2/rsutil.h
# Automatically generated using Clang.jl wrap_c, version 0.0.0


function rs2_project_point_to_pixel(pixel, intrin, point)
    ccall((:rs2_project_point_to_pixel, librealsense2), Void, (NTuple{2, Cfloat}, Ptr{Void}, NTuple{3, Cfloat}), pixel, intrin, point)
end

function rs2_deproject_pixel_to_point(point, intrin, pixel, depth)
    ccall((:rs2_deproject_pixel_to_point, librealsense2), Void, (NTuple{3, Cfloat}, Ptr{Void}, NTuple{2, Cfloat}, Cfloat), point, intrin, pixel, depth)
end

function rs2_transform_point_to_point(to_point, extrin, from_point)
    ccall((:rs2_transform_point_to_point, librealsense2), Void, (NTuple{3, Cfloat}, Ptr{Void}, NTuple{3, Cfloat}), to_point, extrin, from_point)
end

function rs2_fov(intrin, to_fov)
    ccall((:rs2_fov, librealsense2), Void, (Ptr{Void}, NTuple{2, Cfloat}), intrin, to_fov)
end
# Julia wrapper for header: librealsense/include/librealsense2/h/rs_internal.h
# Automatically generated using Clang.jl wrap_c, version 0.0.0
...
function rs2_software_sensor_on_video_frame(sensor, frame, error)
    ccall((:rs2_software_sensor_on_video_frame, librealsense2), Void, (Ptr{rs2_sensor}, rs2_software_video_frame, Ptr{Ptr{rs2_error}}), sensor, frame, error)
end

function rs2_software_device_create_matcher(dev, matcher, error)
    ccall((:rs2_software_device_create_matcher, librealsense2), Void, (Ptr{rs2_device}, rs2_matchers, Ptr{Ptr{rs2_error}}), dev, matcher, error)
end
...
function rs2_software_sensor_add_read_only_option(sensor, option, val, error)
    ccall((:rs2_software_sensor_add_read_only_option, librealsense2), Void, (Ptr{rs2_sensor}, rs2_option, Cfloat, Ptr{Ptr{rs2_error}}), sensor, option, val, error)
end

function rs2_software_sensor_update_read_only_option(sensor, option, val, error)
    ccall((:rs2_software_sensor_update_read_only_option, librealsense2), Void, (Ptr{rs2_sensor}, rs2_option, Cfloat, Ptr{Ptr{rs2_error}}), sensor, option, val, error)
end
# Julia wrapper for header: librealsense/include/librealsense2/h/rs_pipeline.h
# Automatically generated using Clang.jl wrap_c, version 0.0.0
...
function rs2_pipeline_stop(pipe, error)
    ccall((:rs2_pipeline_stop, librealsense2), Void, (Ptr{rs2_pipeline}, Ptr{Ptr{rs2_error}}), pipe, error)
end
...
function rs2_delete_pipeline(pipe)
    ccall((:rs2_delete_pipeline, librealsense2), Void, (Ptr{rs2_pipeline},), pipe)
end
...
function rs2_delete_pipeline_profile(profile)
    ccall((:rs2_delete_pipeline_profile, librealsense2), Void, (Ptr{rs2_pipeline_profile},), profile)
end
...
function rs2_delete_config(config)
    ccall((:rs2_delete_config, librealsense2), Void, (Ptr{rs2_config},), config)
end

function rs2_config_enable_stream(config, stream, index, width, height, format, framerate, error)
    ccall((:rs2_config_enable_stream, librealsense2), Void, (Ptr{rs2_config}, rs2_stream, Cint, Cint, Cint, rs2_format, Cint, Ptr{Ptr{rs2_error}}), config, stream, index, width, height, format, framerate, error)
end

function rs2_config_enable_all_stream(config, error)
    ccall((:rs2_config_enable_all_stream, librealsense2), Void, (Ptr{rs2_config}, Ptr{Ptr{rs2_error}}), config, error)
end

function rs2_config_enable_device(config, serial, error)
    ccall((:rs2_config_enable_device, librealsense2), Void, (Ptr{rs2_config}, Cstring, Ptr{Ptr{rs2_error}}), config, serial, error)
end

function rs2_config_enable_device_from_file(config, file, error)
    ccall((:rs2_config_enable_device_from_file, librealsense2), Void, (Ptr{rs2_config}, Cstring, Ptr{Ptr{rs2_error}}), config, file, error)
end

function rs2_config_enable_record_to_file(config, file, error)
    ccall((:rs2_config_enable_record_to_file, librealsense2), Void, (Ptr{rs2_config}, Cstring, Ptr{Ptr{rs2_error}}), config, file, error)
end

function rs2_config_disable_stream(config, stream, error)
    ccall((:rs2_config_disable_stream, librealsense2), Void, (Ptr{rs2_config}, rs2_stream, Ptr{Ptr{rs2_error}}), config, stream, error)
end

function rs2_config_disable_indexed_stream(config, stream, index, error)
    ccall((:rs2_config_disable_indexed_stream, librealsense2), Void, (Ptr{rs2_config}, rs2_stream, Cint, Ptr{Ptr{rs2_error}}), config, stream, index, error)
end

function rs2_config_disable_all_streams(config, error)
    ccall((:rs2_config_disable_all_streams, librealsense2), Void, (Ptr{rs2_config}, Ptr{Ptr{rs2_error}}), config, error)
end
