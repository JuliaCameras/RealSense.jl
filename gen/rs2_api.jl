...
# Julia wrapper for header: rs_advanced_mode.h
# Automatically generated using Clang.jl
...
# Julia wrapper for header: rsutil.h
# Automatically generated using Clang.jl
...
# Julia wrapper for header: rs_advanced_mode_command.h
# Automatically generated using Clang.jl

# Julia wrapper for header: rs_config.h
# Automatically generated using Clang.jl
...
# Julia wrapper for header: rs_context.h
# Automatically generated using Clang.jl
...
# Julia wrapper for header: rs_device.h
# Automatically generated using Clang.jl
...
# Julia wrapper for header: rs_frame.h
# Automatically generated using Clang.jl
...
# Julia wrapper for header: rs_internal.h
# Automatically generated using Clang.jl
...
# Julia wrapper for header: rs_option.h
# Automatically generated using Clang.jl
...
function rs2_get_option_name(options, option, error)
    ccall((:rs2_get_option_name, librealsense2), Cstring, (Ptr{rs2_options}, rs2_option, Ptr{Ptr{rs2_error}}), options, option, error)
end
...
# Julia wrapper for header: rs_pipeline.h
# Automatically generated using Clang.jl
...
# Julia wrapper for header: rs_processing.h
# Automatically generated using Clang.jl
...
function rs2_get_processing_block_info(block, info, error)
    ccall((:rs2_get_processing_block_info, librealsense2), Cstring, (Ptr{rs2_processing_block}, rs2_camera_info, Ptr{Ptr{rs2_error}}), block, info, error)
end
...
# Julia wrapper for header: rs_record_playback.h
# Automatically generated using Clang.jl
...
function rs2_create_record_device_ex(device, file, compression_enabled, error)
    ccall((:rs2_create_record_device_ex, librealsense2), Ptr{rs2_device}, (Ptr{rs2_device}, Cstring, Cint, Ptr{Ptr{rs2_error}}), device, file, compression_enabled, error)
end
...
# Julia wrapper for header: rs_sensor.h
# Automatically generated using Clang.jl
...
function rs2_import_localization_map(sensor, lmap_blob, blob_size, error)
    ccall((:rs2_import_localization_map, librealsense2), Cint, (Ptr{rs2_sensor}, Ptr{Cuchar}, UInt32, Ptr{Ptr{rs2_error}}), sensor, lmap_blob, blob_size, error)
end
...
function rs2_set_static_node(sensor, guid, pos, orient, error)
    ccall((:rs2_set_static_node, librealsense2), Cint, (Ptr{rs2_sensor}, Cstring, rs2_vector, rs2_quaternion, Ptr{Ptr{rs2_error}}), sensor, guid, pos, orient, error)
end

function rs2_get_static_node(sensor, guid, pos, orient, error)
    ccall((:rs2_get_static_node, librealsense2), Cint, (Ptr{rs2_sensor}, Cstring, Ptr{rs2_vector}, Ptr{rs2_quaternion}, Ptr{Ptr{rs2_error}}), sensor, guid, pos, orient, error)
end

function rs2_load_wheel_odometry_config(sensor, odometry_config_buf, blob_size, error)
    ccall((:rs2_load_wheel_odometry_config, librealsense2), Cint, (Ptr{rs2_sensor}, Ptr{Cuchar}, UInt32, Ptr{Ptr{rs2_error}}), sensor, odometry_config_buf, blob_size, error)
end

function rs2_send_wheel_odometry(sensor, wo_sensor_id, frame_num, translational_velocity, error)
    ccall((:rs2_send_wheel_odometry, librealsense2), Cint, (Ptr{rs2_sensor}, UInt8, UInt32, rs2_vector, Ptr{Ptr{rs2_error}}), sensor, wo_sensor_id, frame_num, translational_velocity, error)
end
...
# Julia wrapper for header: rs_types.h
# Automatically generated using Clang.jl
...
function rs2_create_error(what, name, args, type)
    ccall((:rs2_create_error, librealsense2), Ptr{rs2_error}, (Cstring, Cstring, Cstring, rs2_exception_type), what, name, args, type)
end
